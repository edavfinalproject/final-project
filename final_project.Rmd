...
Moving to Middle income countries we see most bracket most countries have data between 1975 and 2010. For our main anlaysis we filtered for this time range to include as many countries as possible.
...
**Figure 3-1. Missing Energy Use (Total population)**
```{r echo=FALSE}
#total population
...
**Figure 3-1. Missing Energy Use (Population growth)**
```{r echo=FALSE}
#population growth
