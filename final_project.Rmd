...
As we look at the ditribution of energy use Figure 4-# above clearly indicates that the United States, India, and China stand out from the rest. However, when we compare there energy use and population to the remaining countries, we see there is less inequality as expected.



there are three clear outlier countries includinggThree countries stand out from the rest. Why do these countries need to be different? Also over the 40 year span these countries are still the only ones separate. This leads me to believe that compounding (potentially capitalism) has influence.
