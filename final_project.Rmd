...
```{r Visna() Graph}
wide_energy <- filter(tidy_pop_energy, 
                      INDICATOR_NAME == "Energy use (kg of oil equivalent per capita)")
wide_energy <- select(wide_energy, YEAR, COUNTRY_CODE, VALUE)
wide_energy <- wide_energy %>% spread(YEAR, VALUE)

visna(wide_energy, sort = 'r')
