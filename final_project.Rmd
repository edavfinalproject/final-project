...
needed_packages <- c("data.table", "tidyverse", "shiny", "WDI")
...
setnames(pop_growth_df, c("COUNTRY_NAME", "VALUE", "YEAR", "COUNTRY_CODE", "REGION", "INCOMEGROUP"))
...
setnames(pop_df, c("COUNTRY_NAME", "VALUE", "YEAR", "COUNTRY_CODE", "REGION", "INCOMEGROUP"))
...
setnames(energy_df, c("COUNTRY_NAME", "VALUE", "YEAR", "COUNTRY_CODE", "REGION", "INCOMEGROUP"))
