...
# install.packages("rstudioapi", repos = "http://cran.us.r-project.org"); library(rstudioapi)

# project_dir <- dirname(rstudioapi::getSourceEditorContext()$path)
# project_files <- list.files(project_dir)
# csv_files <- project_files[project_files %like% "csv$"]

# for (i in csv_files) {
#      file_path <- paste0(project_dir,"/",i)
#      csv <- fread(file_path)
