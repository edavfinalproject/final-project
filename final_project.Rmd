...
However, we see there is a lot of information hidden when average over the entire world. Figure 5-4 below shows the relationship between energy use and population for each country in 2010. 
...
From the scatter we immediately see there are outliers, specifically China, India, and the United States. The figure below shows these countries took different path to be outliers.
```{r echo = FALSE, fig.width=20}
# Make plot
ggplot(data = scatter_data[scatter_data$COUNTRY_NAME %in% c("China", "United States", "India"), ], 
       aes(x=pop_tot, y=energy_tot, col=COUNTRY_NAME)) +
...
### Conclusion
Our biggest lesson learned was our hypothesis that the strong direct relationship between energy and population growth was not the full story was correct. Simply when breaking down by country the correlation was less visible. We hope this inspires others, as our team has been, to think deeply about how population and energy factor into our paths to sustainability.
